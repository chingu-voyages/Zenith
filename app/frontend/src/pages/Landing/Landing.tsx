            ...
            <div className="my-20 grid lg:grid-cols-3 md:grid-cols-2 lg:grid-rows-2 md:grid-rows-3 gap-6">
              <div className="feature-item flex flex-col items-center justify-center shadow-md hover:shadow-lg border border-gray-200 rounded-lg p-4">
                ...
                <p className="text-gray-500 pt-3 text-center">
                  Pin and save coordinates of the highest elevations or
                  preferred locations.
                </p>
              </div>
              <div className="feature-item flex flex-col items-center justify-center shadow-md hover:shadow-lg border border-gray-200 rounded-lg p-4">
              ...
              <div className="feature-item flex flex-col items-center justify-center shadow-md hover:shadow-lg border border-gray-200 rounded-lg p-4">
                ...
                <p className="text-gray-500 pt-3 text-center">
                  Set elevation limits to focus on peaks within preferred
                  ranges.
                </p>
              </div>
              <div className="feature-item flex flex-col items-center justify-center shadow-md hover:shadow-lg border border-gray-200 rounded-lg p-4">
                ...
                <p className="text-gray-500 pt-3 text-center">
                  Access educational resources on handling terrain difficulty
              ...
              <div className="feature-item flex flex-col items-center justify-center shadow-md hover:shadow-lg border border-gray-200 rounded-lg p-4">
                ...
                <p className="text-gray-500 pt-3 text-center">
                  Export shareable links for peak coordinates in navigation
                  apps.
                </p>
              </div>
            </div>
